...
1. Skim the numbered list — *hardware validation → control plane → IaC → security → automation*.
2. Click any repo.
3. Look for **runbooks**, **verify scripts**, and a clear **done** definition.
4. Ask interview questions from the tags (NVML, PCIe, Terraform, Lambda, IAM, boto3, Ansible).
